  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink-950 px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-display text-2xl font-medium text-mist-50">Create your account</h1>
        <p className="mt-1 text-sm text-mist-300">Start analyzing code in under a minute.</p>
